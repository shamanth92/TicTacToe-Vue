  ...
  switch (selectedOption.value) {
    case '3':
      if (playerOneWins.value === 2 || playerTwoWins.value === 2) {
        gameWinner.value = playerOneWins.value === 2 ? playerOne.value : playerTwo.value
        endGame.value = true
        confetti({
          particleCount: 160,
          spread: 75,
    ...
    case '5':
      if (playerOneWins.value === 3 || playerTwoWins.value === 3) {
        gameWinner.value = playerOneWins.value === 3 ? playerOne.value : playerTwo.value
        endGame.value = true
        confetti({
          particleCount: 160,
          spread: 75,
    ...
    case '7':
      if (playerOneWins.value === 4 || playerTwoWins.value === 4) {
        gameWinner.value = playerOneWins.value === 4 ? playerOne.value : playerTwo.value
        endGame.value = true
        confetti({
          particleCount: 160,
          spread: 75,
...
<template>
  <div class="bg-rose-50 h-screen grid grid-cols-3">
    <div class="flex flex-col gap-3 p-8">
      <p class="font-serif">{{ !startGameOption ? 'Enter Player Names:' : 'Current Players:' }}</p>
...
//Restart - Fix to check deployment //Actions //Deploy //More Games
